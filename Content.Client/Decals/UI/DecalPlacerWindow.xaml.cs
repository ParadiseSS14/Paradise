...
public sealed partial class DecalPlacerWindow : DefaultWindow
{
    ...
    private CleaningType _cleaningType; // Paradise Change - Cleaning
    private int _zIndex;
    ...
    public DecalPlacerWindow()
    {
        ...
        // Paradise Change START - Cleaning
        CleaningTypePicker.OnItemSelected += args =>
        {
            _cleaningType = (CleaningType) args.Id;
            CleaningTypePicker.SelectId(args.Id);
            UpdateDecalPlacementInfo();
        };
        // Paradise Change END - Cleaning
    ...
    private void UpdateDecalPlacementInfo()
    {
        ...
        _decalPlacementSystem.UpdateDecalInfo(_selected, color, _rotation, _snap, _zIndex, _cleaningType);
    }
    ...
    private void SelectDecal(string decalId)
    {
        ...
        {
            // Paradise Change START - Cleaning
            CleaningTypePicker.SelectId((int)decal.CleaningType);
            _cleaningType = decal.CleaningType;
            // Paradise Change END - Cleaning
