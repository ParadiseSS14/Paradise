...
public sealed partial class SprayPainterDecals : Control
{
    ...
    public SprayPainterDecals()
    {
        ...
        ColorSelectorButton.OnPressed += _ =>
        {
            if (_colorPicker != null)
                return;
            _colorPicker = new ColorPicker(SelectedColor);
            _colorPicker.OpenCentered();
            _colorPicker.OnSaveColors += OnColorSelected;
    ...
    {
        OnColorChanged?.Invoke(UseCustomColorCheckBox.Pressed ? SelectedColor : null);
    ...
    {
        Color modulateColor = apply ? SelectedColor : Color.White;
