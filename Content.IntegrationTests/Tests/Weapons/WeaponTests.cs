...
public sealed class WeaponTests : InteractionTest
{
    ...
    private static readonly EntProtoId SniperMosin = "WeaponSniperMosinTest"; //PARADISE EDIT - Weapon Overhaul //This requires Mosin to use BallisticAmmoProvider and results in test failures if changed to ChamberMagazine
