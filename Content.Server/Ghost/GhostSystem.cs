...
namespace Content.Server.Ghost
{
    public sealed partial class GhostSystem : SharedGhostSystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<GhostComponent, EntityGotUnvisitedEvent>(OnMindUnvisitedMessage);// PARADISE EDIT - Visiting mind overhaul
        ...
        private void OnMindUnvisitedMessage(EntityUid uid, GhostComponent component, EntityGotUnvisitedEvent args) // PARADISE EDIT - Visiting mind overhaul
        {
            DeleteEntity(uid);
        }
