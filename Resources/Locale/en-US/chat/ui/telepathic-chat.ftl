chat-manager-send-telepathic-chat-wrap-message = You hear {$source}'s voice: {$message}
chat-manager-send-telepathic-chat-wrap-message-admin = {$source}: Telepathically said {$message} using Project Mind
